...
2. Section fitur yang relevan di `docs/feature-specs.md` (§00-§08), atau `docs/09-data-layer-wiring.md` kalau soal data layer — ikuti step-by-step dan checklist di dalamnya PERSIS, jangan improvisasi struktur yang beda tanpa alasan. Checklist di `feature-specs.md` itu acceptance criteria original, bukan status hidup — status terkini selalu di `docs/PROGRESS.md`.
