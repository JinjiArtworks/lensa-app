...
- **Tier:**
  - **Free** — 1 bisnis, bisa connect **1 platform** (pilih salah satu: Meta Ads *atau* TikTok Ads), 1 pengguna (tanpa invite tim), AI Insight dasar (ringkasan angka + Rekomendasi Prioritas selalu terbuka sebagai teaser nilai AI; grid "Semua Insight" lengkap kategori Positif saja, Perlu Aksi/Rekomendasi di grid tetap Pro-only), histori data 7 hari, tanpa export & tanpa multi-bisnis. *(Revisi dari draf awal yang 2 platform — sengaja dipersempit biar gap benefit ke Pro lebih tegas & realistis buat model freemium. Ringkasan+Rekomendasi Prioritas dibuka lagi buat Free di sesi keempatbelas — lihat `PROGRESS.md`.)*
